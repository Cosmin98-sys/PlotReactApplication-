...
function orderBy(data, descriptors, subItemsField) {
    return kendo_react_data_tools_1.orderBy(data, descriptors, subItemsField);
}
...
function filterBy(data, descriptors, subItemsField) {
    return kendo_react_data_tools_1.filterBy(data, descriptors, subItemsField);
}
...
exports.mapTree = function (tree, subItemsField, callback) {
    return kendo_react_common_1.mapTree(tree, subItemsField, callback);
};
/**
 * Creates a new array with the results of calling the provided callback function
...
exports.mapTreeItem = function (tree, level, subItemsField, callback) {
    return kendo_react_common_1.mapTreeItem(tree, level, subItemsField, callback);
};
/**
 * @hidden
 */
 ...
 */
exports.treeToFlat = function (data, expandField, subItemsField) {
    var expanded = function (dataItem) { return Boolean(index_1.getNestedValue(expandField, dataItem)); };
    var hasChildren = function (dataItem) { return Boolean(index_1.getNestedValue(subItemsField, dataItem)); };
    var getChildren = function (dataItem) {
        var items = [];
        if (expanded(dataItem) && hasChildren(dataItem)) {
            items.push.apply(items, index_1.getNestedValue(subItemsField, dataItem));
        }
        return items;
    };
 ...
 */
exports.createDataTree = function (dataset, getId, getParentId, subItemsField) {
...
exports.extendDataItem = function (item, subItemsField, propsToExtend) {
    return kendo_react_common_1.extendDataItem(item, subItemsField, propsToExtend);
};
/**
 ...
 * @returns {any[]} - The new data tree.
 */
exports.removeItems = function (data, subItemsField, condition) {
    var _a;
    var newData = exports.mapTree([(_a = {}, _a[subItemsField] = data.slice(), _a)], subItemsField, function (item) { return removeChild(item, condition, subItemsField); });
 ...
 * @returns {any[]} - The new data tree.
 */
exports.modifySubItems = function (data, subItemsField, condition, change) {
    return exports.mapTree(data, subItemsField, function (item) {
        var _a;
...
exports.getItemPath = function (tree, level, subItemsField) {
    return kendo_react_common_1.getItemPath(tree, level, subItemsField);
};
/**
 ...
 * @returns {any[]} - The new data tree.
 */
exports.moveTreeItem = function (data, target, destination, subItemsField) {
    var tree = data.slice();
    var targetItemPath = exports.getItemPath(tree, target, subItemsField);
    var targetItem = targetItemPath.pop();
    var targetParent = targetItemPath.pop();
    var targetItemIndex = target[target.length - 1];
    if (destination) {
        var destinationItemPath = exports.getItemPath(tree, destination, subItemsField);
