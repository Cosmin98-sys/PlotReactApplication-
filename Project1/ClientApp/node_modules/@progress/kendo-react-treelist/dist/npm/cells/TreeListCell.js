...
exports.TreeListCell = function (props) {
    ...
    if (props.expandable) {
        ...
        if (hasChildren) {
            icons.push(React.createElement("span", __assign({ className: "k-icon k-i-" + (expanded ? 'collapse' : 'expand'), key: "expand-collapse", onClick: function (event) { return props.onExpandChange(event, dataItem, level); } }, (_a = {}, _a[constants_1.TREELIST_PREVENT_SELECTION_ELEMENT] = true, _a))));
        }
        else {
