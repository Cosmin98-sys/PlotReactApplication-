...
export var TreeListCell = function (props) {
    ...
    if (props.expandable) {
        ...
        if (hasChildren) {
            icons.push(React.createElement("span", __assign({ className: "k-icon k-i-" + (expanded ? 'collapse' : 'expand'), key: "expand-collapse", onClick: function (event) { return props.onExpandChange(event, dataItem, level); } }, (_a = {}, _a[TREELIST_PREVENT_SELECTION_ELEMENT] = true, _a))));
        }
        else {
            icons.push(React.createElement("span", { className: "k-icon k-i-none", key: icons.length }));
        }
    }
    var defaultRendering = (React.createElement("td", __assign({ style: props.style, className: classNames(props.className, (_b = {},
            _b['k-text-nowrap'] = props.expandable,
            _b['k-state-selected'] = isSelected,
