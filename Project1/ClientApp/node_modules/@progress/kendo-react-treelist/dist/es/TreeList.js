...
var TreeList = /** @class */ (function (_super) {
    ...
    TreeList.prototype.render = function () {
        ...
        var dataRow = function (item, inEdit, rowId, isRowExpanded, rowDataIndex, selectedValue) { return columnsWithColGroup.map(function (column, columnIndex) {
            ...
            return React.createElement(TreeListCell, __assign({ key: columnIndex }, cellProps));
        }); };
        ...
        var body = flattedData.length > 0 && flattedData.map(function (item, rowIndex) {
            ...
            React.createElement("td", { colSpan: columnsWithColGroup.length }, this.props.noRecords || React.createElement(TreeListNoRecords, null))));
        ...
        return (React.createElement(TableKeyboardNavigationContext.Provider, { value: this.contextStateRef.current },
            React.createElement("div", __assign({ style: this.props.style, className: classNames('k-widget k-grid', this.props.className, { 'k-treelist-scrollable': scrollable !== 'none' }), ref: function (e) { return _this.element = e; }, onScroll: virtualScroll ? this.handleOnScroll : undefined, onKeyDown: this.onKeyDown, onFocus: this.onFocus, "aria-rowcount": total, "aria-colcount": columnsWithColGroup.length, role: 'treegrid' }, tableKeyboardNavigationScopeAttributes),
                this.props.toolbar,
